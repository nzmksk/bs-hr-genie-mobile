...
const Color cardColor = Color(0xFF282828);
const Color disabledButtonColor = Color(0xFF999999);
const Color selectedButtonColor = Color.fromARGB(255, 44, 124, 228);
const Color unselectedButtonColor = Color.fromARGB(255, 95, 104, 116);
const Color errorBorderColor = Color.fromARGB(255, 226, 39, 39);
